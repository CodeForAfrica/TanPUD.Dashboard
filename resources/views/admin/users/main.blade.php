...
@section('title')
    Administrator - Administrators | Moyo - Code for Tanzania
@stop
        ...
        <div class="row">
            ...
            <div class="col-md-10 contents">
                <div class="header">
                    <div class="row">
                        <div class="col-md-10">
                            <h2>Administrators <small class="color-pink"> - View All</small></h2>
                        </div>
                                ...
                                <tbody style="text-align:left;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" type="button" class="btn btn-xs btn-success no-radius">View</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
